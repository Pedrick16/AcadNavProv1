...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<title>Register - Academia360</title>
...
<body >
  ...
  <section class="center-text">
    ...
    <div class="registration-form box-center clearfix" style=" box-shadow: 0 2px 4px rgba(0, 0, 0, .1), 0 8px 16px rgba(0, 0, 0, .1);   background-color: white;">
